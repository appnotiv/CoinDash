...
public class TransactionHistoryAdapter extends RecyclerView.Adapter<TransactionHistoryAdapter.MyViewHolder> {
    ...
    private ArrayList<TransactionsResponse.Info> listTicket;
    ...
    public TransactionHistoryAdapter(Context mContext, ArrayList<TransactionsResponse.Info> listTicket) {
