...
public class FragmentLevelSummery extends Fragment {
    private AdvancedWebView webView;

    public FragmentLevelSummery() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_webview, container, false);
        MainActivity.mainTitle.setText("Level Summery");
        return v;
    }
    ...
    private void init(View v) {
        ...
        String url = WsConstant.URL + "LevelSummarySponsorWise.php?TokenData=" + AppGlobal.getId(getActivity())
